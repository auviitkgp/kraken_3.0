...
def main():
	...
	# 							 remapping={'x':'x','y':'y','depth':'depth','time_out':'time'})
			smach.StateMachine.add('DETECTING_STATE',MarkerDetect(resources),
	...
	# 							transitions={'found':'ALIGINING_VEHICLE','time_out':'marker_undetected'})
		...
		smach.StateMachine.add('ALIGINING_VEHICLE',
								...
								remapping={'time_out':'10','e_x':'ex','e_y':'ey'}
								)
...
#	if outcome=='succeeded':
	...
	goal=controllerGoal()
	goal.y=0.5
	resources.setPointController.send_goal(goal)
