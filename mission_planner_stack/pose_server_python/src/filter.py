...
#P = matrix([[1000.,0.,0.,0.],[0.,1000.0,0.,0.],[0.,0.,1000.0,0.],[0.,0.,0.,1000.0]]);
...
# kalman_estimate(x, P, measurements[0])

# 0 x = 0 0 vx vy p y <- filter -> xt Pt
# xt[0] xt[1] vx vy p y <- filter -> xt+1 Pt+1
