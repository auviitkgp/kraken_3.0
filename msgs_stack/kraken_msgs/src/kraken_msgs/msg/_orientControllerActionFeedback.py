"""autogenerated by genpy from kraken_msgs/orientControllerActionFeedback.msg. Do not edit."""
import sys
...
class orientControllerActionFeedback(genpy.Message):
  _md5sum = "2167757dbef5e654b8ae17e47d0d389c"
  _type = "kraken_msgs/orientControllerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kraken_msgs/orientControllerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(orientControllerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = kraken_msgs.msg.orientControllerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = kraken_msgs.msg.orientControllerFeedback()
