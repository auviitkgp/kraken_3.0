...
class controllerAction(genpy.Message):
  _md5sum = "2ff05f2ea68d5b1be490c24ea4f27ebf"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4f3I.pack(_x.action_goal.goal.heading_setpoint, _x.action_goal.goal.forward_setpoint, _x.action_goal.goal.rightmove_setpoint, _x.action_goal.goal.depth_setpoint, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4f3I.pack(_x.action_result.result.heading_final, _x.action_result.result.forward_final, _x.action_result.result.rightmove_final, _x.action_result.result.depth_final, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4f.pack(_x.action_feedback.feedback.heading_error, _x.action_feedback.feedback.forward_error, _x.action_feedback.feedback.rightmove_error, _x.action_feedback.feedback.depth_error))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.heading_setpoint, _x.action_goal.goal.forward_setpoint, _x.action_goal.goal.rightmove_setpoint, _x.action_goal.goal.depth_setpoint, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_4f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.heading_final, _x.action_result.result.forward_final, _x.action_result.result.rightmove_final, _x.action_result.result.depth_final, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_4f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.heading_error, _x.action_feedback.feedback.forward_error, _x.action_feedback.feedback.rightmove_error, _x.action_feedback.feedback.depth_error,) = _struct_4f.unpack(str[start:end])
      return self
